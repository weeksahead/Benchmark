    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-red-600 hover:bg-red-700 text-white px-4 py-3 sm:px-5 sm:py-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 z-50 flex items-center space-x-2"
        >
          <MessageCircle className="w-5 h-5 sm:w-6 sm:h-6" />
          <span className="font-semibold text-sm sm:text-base">Tyler AI</span>
        </button>
      )}
